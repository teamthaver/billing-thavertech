...
type FollowUpStatus = "process" | "not_interested" | "converted";

type ProspectFollowUpFormData = {
...
export const insertProspectFollowUp = async (
  ...
  try {
    ...
    console.error("Insert Follow Up Error:", error);
...
export const convertProspectToClient = async (prospectId: number) => {
  ...
  try {
    ...
    // 3. Get all documents of this prospect
